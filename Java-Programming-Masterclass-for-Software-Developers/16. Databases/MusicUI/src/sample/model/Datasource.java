...
public class Datasource {
    ...
    public static final String CONNECTION_STRING = "jdbc:sqlite:C:\\Users\\jasie\\IdeaProjects\\Music\\" + DB_NAME;
    ...
    // INNER JOIN artist ON albums.artist = artists._id ORDER BY artists.name,
    ...
    private PreparedStatement queryAlbumsByArtitsId;
    ...
    public boolean open() {
        try {
            ...
            queryAlbumsByArtitsId = conn.prepareStatement(QUERY_ALBUMS_BY_ARTIST_ID);
    ...
    public void close() {
        try {
            ...
            if(queryAlbumsByArtitsId != null) {
                queryAlbumsByArtitsId.close();
            }
    ...
    public List<Album> queryAlbumsForArtistId(int id) {
        try {
            queryAlbumsByArtitsId.setInt(1, id);
            ResultSet results = queryAlbumsByArtitsId.executeQuery();
    ...
    private int insertAlumb(String name, int artistId) throws SQLException {
    ...
    public void insertSong(String title, String artist, String album, int track) {
        ...
        try {
            ...
            int albumId = insertAlumb(album, artistId);
